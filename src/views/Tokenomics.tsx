        ...
        <div style={BG_Img}>
          <div style={BG_Txt}>
           <h1> Tokenomics</h1>
            ...
            &emsp;- open market (free available)<br></br>
            &emsp;- community (early birds)<br></br>
            &emsp;- buyback prog. (for continously increasing liquidity)<br></br>
            &emsp;- burned (by hodlers)<br></br>
            ...
            &emsp;-	Token locking: 8 Streams re-emitting Raydium LP tokens to foundation wallet<br></br>
            &emsp;-	Vesting contracts: token locking is irreversible (can’t be dissolved for rug pull)<br></br>
            &emsp;-	Time spawn: 2 years (ending  Q1/2025)<br></br>
            &emsp;-	Emission rate: linear (LP tokens are emitted in equal parts each month)<br></br>
            <br></br>
            <div style ={{display:'flex', justifyContent:'center'}}>
                        <img
